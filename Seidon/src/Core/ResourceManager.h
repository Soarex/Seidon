...
namespace Seidon
{
	...
	public:
		...
		inline void RegisterAsset(Asset* asset, const std::string& path) { idToAssetPath[asset->id] = path; }

		inline bool IsAssetRegistered(UUID id) { return idToAssetPath.count(id); }
